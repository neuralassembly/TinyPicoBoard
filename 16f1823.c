/*
 * File:   tinypicoboard16f1823.c
 * Author: kanamaru
 *
 * Created on 2016/10/18, 19:18
 */
#include <xc.h>
...
void main()
{
     ...
     ANSELA = 0b00010111 ;  // Analog input (RA4, RA2, RA1, RA0)
     TRISA  = 0b00111111 ;  // Digital input (RA5), Analog input (RA4, RA2, RA1, RA0)
     ANSELC = 0b00000111 ;  // Analog input (RC2, RC1, RC0)
     TRISC  = 0b00000111 ;  // Analog input (RC2, RC1, RC0)
